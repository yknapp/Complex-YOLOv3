...
class Audi2KittiDataset(torch_data.Dataset):
    ...
    def __init__(self, split='train'):
        ...
        self.bev_path   = os.path.join(root_dir, "bev")
    ...
    def get_bev(self, timestamp, idx):
        bev_file = os.path.join(self.bev_path, '%s_lidar_frontcenter_%s.npy' % (timestamp, idx))
